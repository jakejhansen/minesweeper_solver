...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper04/run-minesweeper.py --nwrk 20 --nags 100 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.1 --regu 0.003 --size 6 --mine 7 > Documents/deep/evolutionary/hpcjobs/Minesweeper04/out01.txt
