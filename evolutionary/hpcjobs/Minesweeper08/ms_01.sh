...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper08/run-minesweeper.py --nwrk 20 --nags 40 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.01 --regu 0.01 --size 6 --mine 7 > Documents/deep/evolutionary/hpcjobs/Minesweeper08/out01.txt
