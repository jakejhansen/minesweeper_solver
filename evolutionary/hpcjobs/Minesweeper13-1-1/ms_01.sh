...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper13-1-1/run-minesweeper.py --nwrk 8 --nags 100 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.01 --regu 0.003 --size 8 --mine 10 > Documents/deep/evolutionary/hpcjobs/Minesweeper13-1-1/out01.txt
