...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper02/run-minesweeper.py --nwrk 8 --nags 60 --ngns 30000 --cint 25 --sigm 0.1 --lrte 0.1 --regu 0.003 --size 6 --mine 7 > Documents/deep/evolutionary/hpcjobs/Minesweeper02/out01.txt
