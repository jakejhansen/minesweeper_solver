...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper16-1/run-minesweeper-conv.py --nwrk 20 --nags 100 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.01 --regu 0.003 --size 6 --mine 6 > Documents/deep/evolutionary/hpcjobs/Minesweeper16-1/out01.txt
