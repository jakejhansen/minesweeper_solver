...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper16-10/run-minesweeper-conv.py --nwrk 20 --nags 50 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.01 --regu 0.0 --size 6 --mine 6 > Documents/deep/evolutionary/hpcjobs/Minesweeper16-10/out01.txt
