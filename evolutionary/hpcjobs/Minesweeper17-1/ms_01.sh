...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper17-2/run-minesweeper-conv.py --nwrk 20 --nags 100 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.001 --regu 0.003 --size 4 --mine 3 > Documents/deep/evolutionary/hpcjobs/Minesweeper17-2/out01.txt
