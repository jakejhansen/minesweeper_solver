...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper03/run-minesweeper.py --nwrk 20 --nags 60 --ngns 30000 --cint 100 --sigm 0.1 --lrte 1 --regu 0.003 --size 6 --mine 7 > Documents/deep/evolutionary/hpcjobs/Minesweeper03/out01.txt
