...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper09/run-minesweeper.py --nwrk 20 --nags 30 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.1 --regu 0.003 --size 4 --mine 3 > Documents/deep/evolutionary/hpcjobs/Minesweeper09/out01.txt
