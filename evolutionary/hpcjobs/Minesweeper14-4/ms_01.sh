...
python3 Documents/deep/evolutionary/hpcjobs/Minesweeper14-4/run-minesweeper.py --nwrk 24 --nags 100 --ngns 100000 --cint 100 --sigm 0.1 --lrte 0.003 --regu 0.003 --size 8 --mine 10 > Documents/deep/evolutionary/hpcjobs/Minesweeper14-4/out01.txt
